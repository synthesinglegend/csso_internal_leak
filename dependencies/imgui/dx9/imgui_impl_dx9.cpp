...
inline void ImGui_ImplDX9_RenderDrawLists(ImDrawData* draw_data)
{
...
IMGUI_API inline LRESULT ImGui_ImplDX9_WndProcHandler(HWND, UINT msg, WPARAM wParam, LPARAM lParam)
{
	ImGuiIO& io = ImGui::GetIO();
	switch (msg)
	{
