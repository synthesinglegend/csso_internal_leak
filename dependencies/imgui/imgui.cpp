...
bool ImGui::ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags) {
	...
	// Используем PushStyleVar для временной корректировки WindowPadding
	...
	// Если не показываем слайдеры, активируем RGB/HSV без ввода
	...
	PopStyleVar();  // Восстанавливаем исходные отступы
