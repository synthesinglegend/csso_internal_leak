...
public:
	color grenade_color;
	void run() noexcept;
	void box_esp(player_t* ent) noexcept;
	void health_bar(player_t* ent) noexcept;
	void player_flags(player_t* ent) noexcept;
	void dm_run() noexcept;
	void nosmoke() noexcept;
...
private:
	...
	void player_rendering(player_t* ent) noexcept;
...
inline std::unique_ptr<c_visuals> g_visuals = std::make_unique<c_visuals>();